...
const Sidebar = ({fullName, avatar, email}: Props) => {
  ...
  return (<aside className='sidebar'>
    <Link href='/'>
      <Image src='/assets/icons/logo.svg' alt='logo' width={160} height={50} className='hidden h-auto lg:block'/>
      <Image src='/assets/icons/logo_single.svg' alt='logo' width={52} height={52} className='block h-auto rounded-full lg:hidden'/>
    </Link>
    ...
    <div className='sidebar-user-info min-w-0 max-w-full'>
